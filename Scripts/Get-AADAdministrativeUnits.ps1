<#
    ...
    .Example
    .\Get-AADAdministrativeUnits.ps1 -Filename "AAD_AdministrativeUnits" -OutputPath c:\temp -SecretCliXMLPath "XXX" -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX" -Verbose
    ...
    .Example
    .\Get-AADAdministrativeUnits.ps1 -Filename "AAD_AdministrativeUnits" -OutputPath c:\temp -SecretCliXMLPath "XXX" -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX"
    Connecting to MS Graph
    Found '2' entries
    Exporting entries to file: 'AAD_AdministrativeUnits_11_21_2022.csv'
