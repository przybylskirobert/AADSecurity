<#
    ...
    .Example
    .\Get-AADDevices.ps1 -Filename "AAD_Devices" -OutputPath c:\temp -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX" -Verbose
    ...
    .Example
    .\Get-AADDevices.ps1 -Filename "AAD_Devices" -OutputPath c:\temp -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX"
    Connecting to MS Graph
    Found '10' entries under 'mvp.azureblog.pl' tenant
    Exporting entries to file: 'AAD_Devices_11_21_2022.csv'    
