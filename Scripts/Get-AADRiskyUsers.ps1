<#
    ...
    .Example
    .\Get-AADRiskyUsers.ps1 -Filename "AAD_RiskyUsers" -OutputPath c:\temp -SecretCliXMLPath "XXX" -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX" -Verbose
    ...
    .Example
    .\Get-AADRiskyUsers.ps1 -Filename "AAD_RiskyUsers" -OutputPath c:\temp -SecretCliXMLPath "XXX" -CertificateThumbprint "XXX" -ApplicationId "XXX" -TenantID "XXXX" -TenantDomainName "XXX"
    Connecting to MS Graph
    Found '2' entries under 'mvp.azureblog.pl' tenant
    Exporting entries to file: 'AAD_RiskyUsers_11_21_2022.csv'
